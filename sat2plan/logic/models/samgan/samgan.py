    ...
    def train(self):
        ...
        for epoch in range(self.n_epochs):
            ...
            for idx, (x, y) in enumerate(self.train_dl):
                ...
                print(f'adv : {self.adversarial_loss(y_fake, y).shape}. cont : {self.content_loss(y_fake, y).shape}, style : {self.style_loss(y_fake,y).shape}')
                ...
                Sam_gan_loss.backward(inplace=True)
